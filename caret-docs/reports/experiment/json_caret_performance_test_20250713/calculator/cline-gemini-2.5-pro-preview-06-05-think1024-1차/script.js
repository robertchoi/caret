...
function clearCalculator() {
    ...
    // In a real app, you might not return the state like this,
    // but for this test setup it's useful.
    // Let's adjust the test to check the global calculator object state instead.
    return state;
}
