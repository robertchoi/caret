...
/**
 * Combines API request start and finish messages in an array of CaretMessages.
 *
 ...
 * @returns A new array of CaretMessage objects with API requests combined.
 *
 * @example
 * const messages = [
 ...
 */
export function combineApiRequests(messages: CaretMessage[]): CaretMessage[] {
	const combinedApiRequests: CaretMessage[] = []
