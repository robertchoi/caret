import { CaretMessage } from "./ExtensionMessage"

/**
 * Combines sequences of command and command_output messages in an array of CaretMessages.
 *
 * This function processes an array of CaretMessages objects, looking for sequences
 ...
 * their text contents.
 *
 * @param messages - An array of CaretMessage objects to process.
 * @returns A new array of CaretMessage objects with command sequences combined.
 *
 * @example
 ...
 */
export function combineCommandSequences(messages: CaretMessage[]): CaretMessage[] {
	const combinedCommands: CaretMessage[] = []
