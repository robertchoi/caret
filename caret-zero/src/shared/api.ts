...
export type ApiStreamChunk = { type: "text"; text: string }
...
export const hyperClovaXLocalModels = {
	"naver-hyperclovax/HyperCLOVAX-SEED-Vision-Instruct-3B": {
		...
		description:
			"Naver's HyperCLOVA X SEED Vision Instruct 3B (3.2B LLM + 0.43B Vision) model. LLaVA-based architecture run locally using Transformers/PyTorch. Supports multimodal input (text, image, video) with 16k context length. Optimized for Korean language tasks. Knowledge cutoff: August 2024.",
	},
} as const satisfies Record<string, ModelInfo>
