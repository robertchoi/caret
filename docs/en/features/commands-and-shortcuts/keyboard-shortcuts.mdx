...
<!-- CARET MODIFICATION: Updated command IDs from cline.* to caret.* for Caret branding -->
...
| ---------------------------------------------------------------------------------------- | --------------------------------------------- |
| [`caret.openInNewTab`](/features/commands-and-shortcuts/overview)                        | Opens Cline in a new editor tab               |
| [`caret.addToChat`](/features/commands-and-shortcuts/code-commands)                      | Adds selected code to Cline chat              |
| [`caret.addTerminalOutputToChat`](/features/commands-and-shortcuts/terminal-integration) | Adds terminal output to Cline                 |
| `caret.focusChatInput`                                                                   | Focuses the Cline chat input field            |
| [`caret.generateGitCommitMessage`](/features/commands-and-shortcuts/git-integration)     | Generates a commit message for staged changes |
| [`caret.explainCode`](/features/commands-and-shortcuts/code-commands)                    | Explains selected code                        |
| [`caret.improveCode`](/features/commands-and-shortcuts/code-commands)                    | Suggests improvements for selected code       |
| [`caret.fixWithCline`](/features/commands-and-shortcuts/code-commands)                   | Fixes code with errors                        |
| `caret.SidebarProvider.focus`                                                       | Opens and focuses the Cline sidebar           |
...
| --------------------- | ------------------------------ | ----------------------------------------- | ----------------------------- |
| Open Cline Sidebar    | `Ctrl+Shift+C` / `Cmd+Shift+C` | `caret.SidebarProvider.focus`        | Opens the Cline sidebar panel |
| New Task              | `Alt+N`                        | `cline.plusButtonClicked`                 | Starts a new Cline task       |
| Add Terminal to Cline | `Alt+T`                        | `caret.addTerminalOutputToChat`           | Adds terminal output to Cline |
